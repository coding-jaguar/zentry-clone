...
const BentoTilt = ({ children, className = "" }) => {
  ...
  const handleMouseMove = (e) => {
    ...
    const rotateX = 75 * (0.5 - y);
    const rotateY = 75 * (0.5 - x);
      ...
      <div className="container mx-auto px-3 md:px-10">
        <div className="px-5 py-32">
          ...
          <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
            Imerse yourself in a rich and ever expanding universe where a
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
          ...
          <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
            <BentoCard
              ...
              description={
                "A gamified social hub, where you can meet, chat, and play with other players"
              }
            />
          </BentoTilt>
          <BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
            <BentoCard
              ...
              description={
                "A crossworld AI agent - elevating your gameplay to be more fun and productive."
              }
            />
          </BentoTilt>
